                                        ...
                                        <div class="row">
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <input type="date" name="order_date" class="form-control"
                                                        id="orderDate" value="{{ $order->order_date }}" required />
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="order_id" class="form-control"
                                                      placeholder="Enter order id"  id="orderId"
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    placeholder="Enter total cost" id="totalCost"
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="location" class="form-control"
                                                        id="location" placeholder="Enter location" value="{{ $order->location }}" required />
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="distributor_name" class="form-control"
                                                        id="distributor" placeholder="Enter distributor name"
                                                        value="{{ $order->distributor_name }}" required />
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="order_by" class="form-control"
                                                        id="orderBy" value="{{ $order->order_by }}" required />
                                                </div>
                                            </div>
                                        </div>
