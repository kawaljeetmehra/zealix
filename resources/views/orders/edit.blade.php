                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="name" class="form-control" id="name" value="{{ $order[0]->order_by }}" placeholder="Enter Name" required />
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="number" name="contact" class="form-control" id="contact" value="{{ $order[0]->contact }}" placeholder="Enter Contact Number" required />
                                    </div>
                                </div>
                            </div>
