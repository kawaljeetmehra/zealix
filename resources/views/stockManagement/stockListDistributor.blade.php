                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <button
                                                            class="btn btn-danger btn-round ms-auto">Out-Stock</button>

                                                        @elseif($product->stock_count < 7) <button
                                                            class="btn btn-warning btn-round ms-auto">Low-Stock</button>
                                                            @else
                                                            <button
                                                                class="btn btn-success btn-round ms-auto">In-Stock</button>
                                                            @endif
                                                    </td>
