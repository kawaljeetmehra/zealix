    ...
    <div class="col-md-4">
        <div class="form-group">
            ...
            <select name="packaging" class="form-select" id="productPackaging"
                required>
                <option value="Box" {{ $product->packaging == 'Box' ? 'selected' : '' }}>Box</option>
                <option value="Bottle" {{ $product->packaging == 'Bottle' ? 'selected' : '' }}>Bottle</option>
            </select>
        </div>
    </div>
    <div class="col-md-4">
        ...
        <div class="form-group">
            ...
            <div class="custom-dropdown">
                <div class="dropdown-selected" onclick="toggleDropdown()">
                    <span id="selectedCategory">{{ old('product_category', $product->category) ?: 'Select Product Category' }}</span>
        ...
        <div class="form-group">
            ...
            <div class="input-group">
                ...
                <select name="quantity_unit" class="form-control"
                    ...
                    <option value="Unit" {{ $product->quantity_unit == 'Unit' ? 'selected' : '' }}>Unit</option>
                    <option value="ML" {{ $product->quantity_unit == 'ML' ? 'selected' : '' }}>ML</option>
                    <option value="L" {{ $product->quantity_unit == 'L' ? 'selected' : '' }}>L</option>
                    <option value="Pack" {{ $product->quantity_unit == 'Pack' ? 'selected' : '' }}>Pack</option>
                </select>
            </div>
        </div>
    </div>
