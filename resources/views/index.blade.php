...
<body>
    ...
    <a href="{{ route('orderstatus.index') }}">
        <i class="fas fa-list-alt"></i> <!-- Use an appropriate icon for order status -->
        <p>Order Status</p>
    </a>
</li>
                    </ul>
                            ...
                            <div class="card">
                                <div class="card-header">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <a class="btn btn-primary btn-round ms-auto" href="/products/create">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="form-button-action">
                                                        <a href="/products/{{$product->id}}/edit" data-toggle="tooltip"
